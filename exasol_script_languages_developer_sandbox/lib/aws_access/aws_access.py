...
class AwsAccess(object):
    def __init__(self, aws_profile: Optional[str]):
        ...
        self._logger = get_status_logger(LogType.AWS_ACCESS)
    ...
    def create_new_ec2_key_pair(self, key_name: str, tag_value: str) -> str:
        ...
        """
        self._logger.debug(f"Running create_new_ec2_key_pair for aws profile {self.aws_profile_for_logging}")
    ...
    def delete_ec2_key_pair(self, key_name: str) -> None:
        ...
        """
        self._logger.debug(f"Running delete_ec2_key_pair for aws profile {self.aws_profile_for_logging}")
        cloud_client = self._get_aws_client("ec2")
    ...
    def upload_cloudformation_stack(self, yml: str, stack_name: str, tags=tuple()) -> None:
        ...
        """
        self._logger.debug(f"Running upload_cloudformation_stack for aws profile {self.aws_profile_for_logging}")
        ...
        try:
            ...
            self._logger.error(f"Error creating changeset for cloud formation template: {e}")
            raise e
        try:
            ...
            self._logger.error(f"Error executing changeset for cloud formation template: {e}")
            self._logger.error(f"Run 'aws cloudformation describe-stack-events --stack-name {stack_name}' to get details.")
            raise e
    ...
    def validate_cloudformation_template(self, cloudformation_yml) -> None:
        ...
        """
        self._logger.debug(f"Running validate_cloudformation_template for aws profile {self.aws_profile_for_logging}")
        cloud_client = self._get_aws_client("cloudformation")
    ...
    def get_all_stack_resources(self, stack_name: str) -> List[StackResource]:
        ...
        """
        self._logger.debug(f"Running get_all_codebuild_projects for aws profile {self.aws_profile_for_logging}")
    ...
    def stack_exists(self, stack_name: str) -> bool:
        ...
        """
        self._logger.debug(f"Running stack_exists for aws profile {self.aws_profile_for_logging}")
        try:
    ...
    def delete_stack(self, stack_name: str) -> None:
        ...
        """
        self._logger.debug(f"Running delete_stack for aws profile {self.aws_profile_for_logging}")
        cf_client = self._get_aws_client('cloudformation')
    ...
    def describe_stacks(self) -> List[CloudformationStack]:
        ...
        """
        self._logger.debug(f"Running describe_stacks for aws profile {self.aws_profile_for_logging}")
        cf_client = self._get_aws_client('cloudformation')
    ...
    def describe_instance(self, instance_id: str) -> EC2Instance:
        ...
        """
        self._logger.debug(f"Running describe_instance for aws profile {self.aws_profile_for_logging}")
        cloud_client = self._get_aws_client("ec2")
    ...
    def create_image_from_ec2_instance(self, instance_id: str, name: str, tag_value: str, description: str) -> str:
        ...
        """
        self._logger.debug(f"Running create_image_from_ec2_instance for aws profile {self.aws_profile_for_logging}")
        cloud_client = self._get_aws_client("ec2")
    ...
    def get_ami(self, image_id: str) -> Ami:
        ...
        """
        self._logger.debug(f"Running get_ami for aws profile {self.aws_profile_for_logging}")
        cloud_client = self._get_aws_client("ec2")
    ...
    def get_instance_status(self, instance_id: str) -> EC2InstanceStatus:
        ...
        """
        self._logger.debug(f"Running get_instance_status for aws profile {self.aws_profile_for_logging}")
        cloud_client = self._get_aws_client("ec2")
    ...
    def list_amis(self, filters: list) -> List[Ami]:
        ...
        """
        self._logger.debug(f"Running list_amis for aws profile {self.aws_profile_for_logging}")
        cloud_client = self._get_aws_client("ec2")
    ...
    def list_snapshots(self, filters: list) -> List[Snapshot]:
        ...
        """
        self._logger.debug(f"Running list_snapshots for aws profile {self.aws_profile_for_logging}")
        cloud_client = self._get_aws_client("ec2")
    ...
    def list_export_image_tasks(self, filters: list) -> List[ExportImageTask]:
        ...
        """
        self._logger.debug(f"Running list_export_image_tasks for aws profile {self.aws_profile_for_logging}")
        cloud_client = self._get_aws_client("ec2")
    ...
    def list_ec2_key_pairs(self, filters: list) -> List[KeyPair]:
        ...
        """
        self._logger.debug(f"Running list_ec2_key_pairs for aws profile {self.aws_profile_for_logging}")
        cloud_client = self._get_aws_client("ec2")
    ...
    def list_s3_objects(self, bucket: str, prefix: str) -> Optional[List[S3Object]]:
        ...
        """
        self._logger.debug(f"Running list_s3_objects for aws profile {self.aws_profile_for_logging}")
    ...
    def get_s3_bucket_location(self, bucket: str) -> Optional[str]:
        ...
        """
        self._logger.debug(f"Running get_s3_bucket_location for aws profile {self.aws_profile_for_logging}")
        cloud_client = self._get_aws_client("s3")
    ...
    def deregister_ami(self, ami_d: str) -> None:
        ...
        De-registers an AMI
        """
        self._logger.debug(f"Running deregister_ami for aws profile {self.aws_profile_for_logging}")
        cloud_client = self._get_aws_client("ec2")
    ...
    def remove_snapshot(self, snapshot_id: str) -> None:
        ...
        Removes a snapshot
        """
        self._logger.debug(f"Running remove_snapshot for aws profile {self.aws_profile_for_logging}")
        cloud_client = self._get_aws_client("ec2")
